...
dependencies {
    ...
    // spring-webflux NUR als Library für den reaktiven WebClient (wie :adapters-knowledge
    // und :adapters-tts) — KEIN spring-boot-starter. Der HA-Tool-Adapter lebt außerhalb
    // des Kerns und spricht Home Assistant (REST POST /api/services/{domain}/{service}).
