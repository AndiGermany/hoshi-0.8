...
dependencies {
    ...
    // und :adapters-tts) — KEIN spring-boot-starter. Der Wiki-Grounding-Adapter lebt
    // außerhalb des Kerns und spricht den Knowledge-Bridge-Sidecar (:8035) über HTTP.
...
application {
    // Live-Grounding-Beweis (bin/hoshi ground): Adapter → echte Bridge :8035.
    mainClass.set("de.hoshi.adapters.knowledge.LiveGroundingSmokeKt")
}
