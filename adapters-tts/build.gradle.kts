...
plugins {
    ...
    // application: erlaubt `:adapters-tts:run` für den isolierten Live-OpenAI-TTS-
    // Smoke (OpenAiTtsLiveSmoke) — analog zu :adapters-brain / :adapters-knowledge.
    application
}
...
dependencies {
    ...
    // KEIN spring-boot-starter. Der TTS-Adapter lebt außerhalb des Kerns.
...
application {
    // Live-OpenAI-TTS-Beweis (isoliert, ohne Brain): "Hallo, ich bin Hoshi." → WAV.
    mainClass.set("de.hoshi.adapters.tts.OpenAiTtsLiveSmokeKt")
}
